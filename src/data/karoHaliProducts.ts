...
export const karoHaliProducts: Product[] = [
  ...
  // 2. DEVİN & KIRAÇ SERİSİ
  {
    ...
    nameEn: 'DEVIN 50',
    category: 'karo-hali',
    shortDesc: '4 mm hav yüksekliği ve 50x50 cm ebatlı tufting düz ilmek karo halı',
    shortDescEn: '4 mm pile height and 50x50 cm size tufted plain loop carpet tile',
    description:
  ...
  // 8. LODOS SERİSİ
  {
    ...
    shortDescEn: 'Woven Loop Pile, Polyflex backed Commercial Class 32 carpet tile',
    description:
  ...
  // 9. YADE SERİSİ
  {
    ...
    shortDescEn: 'PA/PES Non-woven, Non-woven Fabric Polyflex backed carpet tile',
    description:
  ...
  // 10. LAVİN SERİSİ
  {
    ...
    shortDescEn: 'Multi-Roll structure, Polyflex backed Commercial Class 32 carpet tile',
    description:
  ...
  // 12. NAZEN SERİSİ
  {
    ...
    shortDescEn: 'Stripe Woven Loop Pile, Light Commercial Class 22 carpet tile',
    description:
  ...
  // 13. GİZ SERİSİ
  {
    ...
    tagsEn: ['GIZ', 'MULTI STRIPE', 'Multi-Color Stripe', 'Light Commercial 22'],
    featured: false,
  },
  ...
  // 14. ALAZ SERİSİ
  {
    ...
    nameEn: 'ALAZ 07',
    category: 'karo-hali',
    shortDesc: '%100 Çözeltide Boyanmış Naylon, Yoğun Ticari Sınıf 33 karo halı',
    shortDescEn: '100% Solution Dyed Nylon, Heavy Commercial Class 33 carpet tile',
    description:
    ...
    featuresEn: [
      ...
      { label: 'Price', value: '₺ 1,096.15 / m²' },
    ],
    tags: ['ALAZ', 'MADRID LINES', 'Naylon', 'SDN', 'Yoğun Ticari 33', 'Premium'],
    tagsEn: ['ALAZ', 'MADRID LINES', 'Nylon', 'SDN', 'Heavy Commercial 33', 'Premium'],
    featured: true,
  },
  ...
  // 16. TAN SERİSİ
  {
    ...
    shortDescEn: 'Twisted Loop Pile, 100% Nylon PA-6 Class 33 luxury carpet tile',
    description:
    ...
    featuresEn: [
      ...
      { label: 'Price', value: '₺ 1,255.65 / m²' },
    ],
    tags: ['TAN', 'SKYPER', 'Naylon PA-6', 'Bükümlü Bukle', 'Sınıf 33', 'Lüks'],
    tagsEn: ['TAN', 'SKYPER', 'Nylon PA-6', 'Twisted Loop', 'Class 33', 'Luxury'],
    featured: true,
  },
  {
    id: 'kh-tan-31',
  ...
  // 17. İNCİ SERİSİ
  {
    ...
    nameEn: 'INCI 86',
    category: 'karo-hali',
    shortDesc: 'Dokuma Bukle Hav, Ticari Sınıf 32 600 g/m² hav ağırlıklı karo halı',
    shortDescEn: 'Woven Loop Pile, Commercial Class 32 600 g/m² pile weight carpet tile',
    description:
