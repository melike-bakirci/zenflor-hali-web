...
export function meta() {
  return seoMeta({
    ...
    description:
      `${SITE_NAME}; ofis, otel ve ticari alanlar için yüksek performanslı akustik karo halı ve uzun ömürlü peyzaj çim halı modelleri sunar. Merkezimiz Sancaktepe Sarıgazi'de olup tüm Türkiye'ye uygun fiyatlı toptan ve perakende satışımız mevcuttur.`,
    keywords:
      ...
      <section className="section home__references" id="home-references">
        <div className="container">
          <div className="home__featured-header">
            ...
            />
            <Link to="/referanslarimiz" className="btn btn-outline home__view-all">
