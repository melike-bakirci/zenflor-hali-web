...
export function meta() {
  return seoMeta({
    ...
    description:
      `${SITE_NAME} İstanbul Sancaktepe Sarıgazi merkez ofisi ile iletişime geçin. Karo halı ve çim halı numune talepleri, adres ve Türkiye geneli projelerinize özel fiyat teklifleri.`,
